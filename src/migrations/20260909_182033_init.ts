...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_events_status" AS ENUM('upcoming', 'ongoing', 'completed');
  CREATE TYPE "public"."enum_events_category" AS ENUM('workshop', 'hackathon', 'competition', 'seminar', 'other');
  CREATE TYPE "public"."enum_teams_category" AS ENUM('faculty', 'core', 'technical', 'design', 'outreach');
  CREATE TYPE "public"."enum_projects_category" AS ENUM('web', 'app', 'ai', 'other');
  CREATE TYPE "public"."enum_gallery_category" AS ENUM('events', 'workshops', 'interaction', 'classes', 'team', 'activities');
  CREATE TYPE "public"."enum_achievements_category" AS ENUM('hackathon', 'competition', 'student', 'milestone', 'certification', 'award');
  CREATE TYPE "public"."enum_certificates_department" AS ENUM('Computer Science and IT', 'Computer Science', 'Information Technology', 'Other');
  CREATE TYPE "public"."enum_certificates_course" AS ENUM('MCA', 'BCA', 'B.Tech', 'M.Tech', 'Other');
  CREATE TYPE "public"."enum_certificates_semester" AS ENUM('1st Semester', '2nd Semester', '3rd Semester', '4th Semester', '1st Year', '2nd Year', '3rd Year');
  ...
  CREATE TABLE "teams" (
  	...
  	"category" "enum_teams_category" NOT NULL,
  	"course_year" varchar,
  ...
  CREATE TABLE "achievements" (
  	...
  	"title" varchar NOT NULL,
  	"description" varchar NOT NULL,
  	"category" "enum_achievements_category" NOT NULL,
  	"date" timestamp(3) with time zone NOT NULL,
  	"image_id" integer,
  	"link" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "certificates" (
  	...
  	"department" "enum_certificates_department" DEFAULT 'Computer Science and IT' NOT NULL,
  	"course" "enum_certificates_course" DEFAULT 'MCA' NOT NULL,
  	"semester" "enum_certificates_semester" DEFAULT '1st Semester' NOT NULL,
  	"internship" varchar NOT NULL,
  ...
  ALTER TABLE "events" ADD CONSTRAINT "events_cover_photo_id_media_id_fk" FOREIGN KEY ("cover_photo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "teams" ADD CONSTRAINT "teams_photo_id_media_id_fk" FOREIGN KEY ("photo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "certificates" ADD CONSTRAINT "certificates_signature_instructor_id_media_id_fk" FOREIGN KEY ("signature_instructor_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "certificates" ADD CONSTRAINT "certificates_signature_coordinator_id_media_id_fk" FOREIGN KEY ("signature_coordinator_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "certificates" ADD CONSTRAINT "certificates_signature_student_coordinator_id_media_id_fk" FOREIGN KEY ("signature_student_coordinator_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "events_cover_photo_idx" ON "events" USING btree ("cover_photo_id");
  ...
  CREATE INDEX "certificates_signature_instructor_idx" ON "certificates" USING btree ("signature_instructor_id");
  CREATE INDEX "certificates_signature_coordinator_idx" ON "certificates" USING btree ("signature_coordinator_id");
  CREATE INDEX "certificates_signature_student_coordinator_idx" ON "certificates" USING btree ("signature_student_coordinator_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_achievements_category";
  DROP TYPE "public"."enum_certificates_department";
  DROP TYPE "public"."enum_certificates_course";
  DROP TYPE "public"."enum_certificates_semester";
