...
export interface User {
  ...
  email: string;
  /**
   * Optional roll number for student login without email.
   */
...
export interface Project {
  id: number;
  name: string;
  category?: ('web' | 'app' | 'ai' | 'other') | null;
  featured?: boolean | null;
  description: string;
  /**
   * E.g. Next.js, Payload CMS, Tailwind CSS
   */
  techStack: string;
  /**
   * Names of the team members who built this
   */
  members: string;
  /**
...
export interface Achievement {
  ...
  title: string;
  description: string;
  category: 'hackathon' | 'competition' | 'student' | 'milestone' | 'certification' | 'award';
  date: string;
  image?: (number | null) | Media;
  /**
   * Optional link to certificate or project
   */
  link?: string | null;
  updatedAt: string;
  createdAt: string;
